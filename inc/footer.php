...
<footer class="footer">
        ...
        <div class="row">
            <div class="col l-2-4 m-4 c-6">
                ...
                <ul class="footer__list">
                    ...
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Câu hỏi thường gặp mua hàng</a>
                    </li>
                    <li class="footer-item">
            ...
            <div class="col l-2-4 m-4 c-6">
                ...
                <ul class="footer__list">
                    ...
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Hướng dẫn mua online</a>
                    </li>
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Hướng dẫn mua trả góp</a>
                    </li>
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Chính sách trả góp</a>
                    </li>
                </ul>
            </div>
            <div class="col l-2-4 m-4 c-6">
    ...
    <div class="footer__bottom">
        <div class="grid wide">
            <p class="footer__text"><strong>© 2022 - Bản quyền thuộc về nhóm Tánh-Thi-Triệu</strong></p>
        </div>
    </div>
</footer>