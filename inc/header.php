...
<head>
    ...
    <link rel="stylesheet" href="/xampp/htdocs/pls/2/assets/css/signin.css"/>
    <link rel="stylesheet" href="/2/assets/css/signin.css">
    <style>
    .tanh{
        ...
        <div class="header-intro">
            <div class="grid wide">
                <nav class="navbar hide-on-mobile-tablet">
                    ...
                    <!-- livestream icon -->
                    <li class="navbar__item">
                            <a href="./live.php" class="navbar-item-link">
                    ...
                    <!-- begin-tac gia -->
                    <li class="navbar__item">
                            <a href="./tacgia.php" class="navbar-item-link">
        ...
        <div class="model__body">
                ...
                <div class="auth-form__container">
                    ...
                    <form action="" method="post"class="auth-form__form">
                        <div class="auth-form__group">
                            <input type="text" name="username" class="auth-form-input" placeholder="Tên người dùng" required="required">
                         
                        </div>

                        <div class="auth-form__group">
                            <input type="email" name="email" class="auth-form-input" placeholder="Nhập email" idrequired="required">
                        </div>

                        <div class="auth-form__group">
                            <input type="text" name="fullname" class="auth-form-input" placeholder="Nhập họ và tên" required="required">
                        </div>

                        <div class="auth-form__group">
                            <input type="password"name ="password" placeholder="Nhập mật khẩu" id="password" class="adu" required style="margin-top:14px; width:100%; height: 40px; padding: 0 12px;border: 1px solid var(--boder-color);font-size: 1.4rem;">
                        </div>
                        <div class="auth-form__group">
                            <input type="password" name= "password2" placeholder="Nhập lại mật khẩu" id="confirm_password" required style="margin-top:14px; width:100%; height: 40px;padding: 0 12px;border: 1px solid var(--boder-color);font-size: 1.4rem;">
                        </div>
            ...
            <div id="login-form" class="auth-form">
                <div class="auth-form__container">
                    ...
                    <form action="" method="post" class="auth-form__form">
                        <div class="auth-form__group">
                            <input type="text" name="usname" class="auth-form-input" placeholder="Username" required="required">
                        </div>
                        <div class="auth-form__group">
                            <input type="password" name="pass" class="auth-form-input" placeholder="Password" required="required">
                        </div>
